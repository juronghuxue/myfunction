<div class="hd_main cle">
    ...
    <div class="head_search_hot">
        <span>热搜榜：</span>
        <a class="red" href="<?= Yii::$app->urlManager->createUrl(['product/search', 'keyword' => 'iPhone']) ?>" target="_self">iPone</a>
        <a href="<?= Yii::$app->urlManager->createUrl(['product/search', 'keyword' => '华为']) ?>" target="_self">华为</a>
        <a href="<?= Yii::$app->urlManager->createUrl(['product/search', 'keyword' => '三星']) ?>" target="_self">三星</a>
        <a class="red" href="<?= Yii::$app->urlManager->createUrl(['product/search', 'keyword' => '联想']) ?>" target="_self">联想</a>
        <a href="<?= Yii::$app->urlManager->createUrl(['product/search', 'keyword' => '荣耀']) ?>" target="_self">荣耀</a>
        <a class="red" href="<?= Yii::$app->urlManager->createUrl(['product/search', 'keyword' => 'Mate']) ?>" target="_self">Mate</a>
    </div>
    <div class="intro">
        <ul>
