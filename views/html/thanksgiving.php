	...
	<div class="thanksgiving">
		...
		<div class="coupon1">
			<div class="clearfix coupon-01-wrap">
				<ul class="coupon-01">
					<li class="img"><img src="/theme/new/images/thanksgiving/pic_tittle_starter_kits.png" /></li>
		...
		<div class="coupon2">
			<div class="clearfix coupon-02-wrap">
				<ul class="coupon-02">
					<li class="img"><img src="/theme/new/images/thanksgiving/pic_tittle_atomizers.png" /></li>
		...
		<div class="coupon3">
			<div class="clearfix coupon-03-wrap">
				<ul class="coupon-03">
					<li class="img"><img src="/theme/new/images/thanksgiving/pic_tittle_mod.png" /></li>
...
<div class="l-year-alert-tip-2">
    ...
    <div class="l-year-alert-footer" style="">
        <a class="home_page"  href="/"> Home Page</a>
    </div>
</div>
...
<script>
	...
	tryfree.forEach(function(val,idx){
		...
		tryfreeStr += '<ul class="ulpic" data-id="'+val.id+'"><li class="img"><a href="'+val.url+'" target="_blank"><img src="'+imgpath+'" onerror="javascript:this.src=\'/theme/new/images/noimg_quesheng.png\';"/></a></li><li class="title"><a href="'+val.url+'" target="_blank">'+val.name+'</a></li><li class="join"><a href="javascript:;" class="join-now">JOIN NOW</a></li><li class="price">$'+val.price+'</li></ul>';
	});
	...
	$('.thanksgiving').on('click','.closeTanchuang',function(){
		$(this).closest('.coupon-tanchuang-wrap').find('img').animate({'height':0,'margin-top':0,'top':'50%','left':'50%'},300,function(){
	...
	function tanchuangfadein(str){
        ...
        var tanchuangStr = '<div class="coupon-tanchuang-wrap"><img src="'+str+'"/><span class="closeTanchuang" style="left:'+left+'px;top:'+top+'px;"></span></div>';
