            ...
            <div class="row">
                <div class="col-md-3 col-sm-4">
                    ...
                    <div class="column mt-10" style="background: #fff;margin-top: 0px">
                        <!-- <h2 class="title-block">Catalog1213</h2> -->
                        ...
                        <div>
                            <div class="shop-bar">
                                ...
                                <form id="sort_by" action="<?= Yii::$app->urlManager->createUrl(['/category/view', 'type' => $type]) ?>" method="get">
                                    ...
                                    <?php if($cid==8){?>
                                     <div class="selector-field f-left ml-30 hidden-xs " style="text-align:  right; width: auto; float: right;">
                                         <span class="brand-official-link" style="float: right; margin-top: 12px;">All <a href="http://www.aspirecig.com/" style="color: #666666" target="_blank" title="www.aspirecig.com">Aspire</a> products from official distributor Elegomall&nbsp;&nbsp;</span>
                                    </div>
                                    <?php } ?>
                                </form>
                            </div>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="home">
                                    <div class="row" style="padding-right:15px;">
                                        <?php if (count($products)) { foreach ($products as $product) { ?>
                                            ...
                                            ?>
                                            <div class="col-lg-3 col-md-3 col-sm-6" style="padding-left:16px;padding-right:0px;">
                                                <div class="single-product mb-30  white-bg">
                                                    ...
                                                    <div class="product-content product-i">
                                                        ...
                                                        <div class="price-box">
                                                            ...
                                                            <?php else:?>
                                                                <span class="price product-price">Coming soon</span>
                                                            <?php endif;?>
                                                            
                                                            <?php if(!empty($productPrice) and $product->market_price>0):?>
                                                    ...
                                                    <?php else:?>
                                                        <div class="other_infor" style="height:37px;">
                                                            <div class="product-icon-left f-left cartOrder01">
                                                                <?php if($OptionSelect):?>
                                                                    <?php if($OptionStock>0):?>
                                                                        <a href="javascript:void(0)" data-id="<?= $product->id ?>"  class="ajaxaddToCartText"><i class="fa fa-shopping-cart"></i>Add to Cart</a>
                              ...
                              $place=$match[1];
                                ...
                                <div role="tabpanel" class="tab-pane" id="profile">
                                    ...
                                    <div class="content-sortpagibar">
                                             <?php  
                                         $page= \yii\widgets\LinkPager::widget(['pagination' => $pagination]);  
                                         // var_dump($pagination->totalCount);
                                        if($page){
                                        $url=Yii::$app->request->getHostInfo()."".Yii::$app->request->url;
                                        $urlarr=  explode("?", $url);
                                       $url= $urlarr[0];
